...
const Login = () => {
  ...
  useEffect(() => {
    const handleVisibilityChange = () => {
      if (document.hidden) {
        console.log('Người dùng đã ẩn tab hoặc chuyển sang tab khác.');
      } else {
            ...
            <div className="authentication-inner">
              <div className="card">
                <div className="card-body">
                  ...
                  <h4 className="mb-2">Express 👋</h4>
                  <p className="mb-4">Hãy đăng nhập trước khi sử dụng các tính năng của website</p>
                  ...
                  <form className="mb-3" onSubmit={handlerSignUp}>
                    ...
                    <div className="mb-3 form-password-toggle">
                      ...
                      <CustomBtn type="submit" label="Đăng nhập" />
                      {/* <button onClick={() => signIn('google')}>Đăng nhập với Google</button> */}
                    </form>

                  <p className="text-center">
                    <span>Nếu bạn chưa có tài khoản trên nền tảng của chúng tôi?</span>
                    <Link href="/register">
...
// Sử dụng getServerSideProps để xử lý session và gọi API trên server
